                ...
                >
                  ...
                  <div className="employee-card-info">
                    ...
                    <div className="employee-card-details">
                      ...
                      <span className="employee-card-id"><span className="material-icons-outlined">badge</span>{emp.employeeId || 'No ID'}</span>
            ...
            {empDetailTab === 'personal' && (
              <div className="profile-card">
                ...
                <div className="profile-info-grid">
                  <div className="profile-info-item"><span className="profile-info-label">Employee ID</span><span className="badge-id">{selectedEmployee.employeeId || 'No ID'}</span></div>
